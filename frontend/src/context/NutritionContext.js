...
export const NutritionProvider = ({ children }) => {
    ...
    const getMealsForDate = useCallback(async (date) => {
        ...
        try {
            ...
            const res = await axios.get(`/api/nutrition/date/${formattedDate}`, config);
    ...
    const getProgressData = useCallback(async (period = 30) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            const res = await axios.get(`/api/nutrition/progress?period=${period}`, config);
    ...
    const addMeal = async (mealData) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            const res = await axios.post('/api/nutrition', mealData, config);
    ...
    const deleteMeal = async (mealId) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            await axios.delete(`/api/nutrition/${mealId}`, config);
    ...
    const getHydrationForDate = useCallback(async (date) => {
        ...
        try {
            ...
            const config = { headers: { 'x-auth-token': token } };
            const formattedDate = date.toISOString().split('T')[0];
            const res = await axios.get(`/api/hydration/date/${formattedDate}`, config);
    ...
    const addHydration = async (logData) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            const res = await axios.post('/api/hydration', logData, config);
    ...
    const deleteHydration = async (logId) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            await axios.delete(`/api/hydration/${logId}`, config);
    ...
    const updateMeal = async (logId, mealData) => {
        ...
        try {
            dispatch({ type: 'SET_LOADING' });
            const config = { headers: { 'x-auth-token': token } };
            const res = await axios.put(`/api/nutrition/${logId}`, mealData, config);
